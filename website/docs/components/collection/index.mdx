...
```ts file=./samples/access_get_or.ts
...
```ts file=./samples/access_get_or_fail.ts
...
```ts file=./samples/callback_arguments.ts
...
```ts file=./samples/serialize_list_collection.ts

```

Serializing and deserializing `IterableCollection`:

```ts file=./samples/serialize_iterable_collection.ts
...
```ts file=./samples/after_or_fail.ts
...
```ts file=./samples/before_or_fail.ts
...
```ts file=./samples/chunk_while.ts
...
```ts file=./samples/first_or_fail.ts
...
```ts file=./samples/get_or_fail.ts
...
```ts file=./samples/insert_after.ts
...
```ts file=./samples/insert_before.ts
...
```ts file=./samples/is_not_empty.ts
...
```ts file=./samples/join_with_separator.ts
...
```ts file=./samples/last_or_fail.ts
...
```ts file=./samples/search_first.ts
...
```ts file=./samples/search_last.ts
...
```ts file=./samples/take_negative.ts
...
```ts file=./samples/to_iterator.ts
...
```ts file=./samples/unique_by_field.ts
...
```ts file=./samples/when_empty.ts

```

```ts file=./samples/when_empty_skip.ts
...
```ts file=./samples/when_not_empty_skip.ts

```

```ts file=./samples/when_not_empty.ts
...
```ts file=./samples/difference_by_field.ts

```

The `difference` method is also available as a static method.

```ts file=./samples/difference_static.ts
