...
```ts file=./samples/lock_factory_initial_config.ts
...
```ts file=./samples/lock_create.ts

```

### Acquiring and releasing the lock

```ts file=./samples/lock_acquire_release.ts

```

Alternatively you could write it as follows:

```ts file=./samples/lock_acquire_or_fail.ts
...
```ts file=./samples/lock_custom_ttl.ts
...
```ts file=./samples/lock_get_state.ts
...
```ts file=./samples/lock_refresh.ts
...
```ts file=./samples/lock_non_refreshable.ts
...
```ts file=./samples/lock_run_or_fail.ts
...
```ts file=./samples/lock_instance_variables.ts
...
```ts file=./samples/lock_custom_id.ts
...
```ts file=./samples/lock_retry_acquire_or_fail.ts

```

Retrying acquiring lock with `acquire` method:

```ts file=./samples/lock_retry_acquire.ts

```

Retrying acquiring lock with `runOrFail` method:

```ts file=./samples/lock_retry_run_or_fail.ts
...
```ts file=./samples/lock_retry_interval_acquire_or_fail.ts

```

Retrying acquiring lock with `acquire` method:

```ts file=./samples/lock_retry_interval_acquire.ts

```

Retrying acquiring lock with `runOrFail` method:

```ts file=./samples/lock_retry_interval_run_or_fail.ts
...
```ts file=./samples/lock_manual_serialization.ts
...
```ts file=./samples/lock_event_bus_serialization.ts
