...
In order to serialize or deserialize a circuit-breaker you need pass an object that implements [`ISerderRegister`](/docs/foundation/serde) contract like the [`Serde`](/docs/foundation/serde) class to `CircuitBreakerFactory`.
