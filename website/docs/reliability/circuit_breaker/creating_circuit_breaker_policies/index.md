...
In order to create custom circuit-breaker you need to implement the [`ICircuitBreakerPolicy`](https://eridu-tech.github.io/eridu-tech-core/types/CircuitBreaker.ICircuitBreakerPolicy.html) contract. Custom circuit-breaker policies can be used with [`DatabaseCircuitBreakerAdapter`](/docs/reliability/circuit_breaker/configuring_circuit_breaker_adapters/#database_circuit_breaker_adapter) and [`DatabaseCircuitBreakerProviderFactory`](/docs/reliability/circuit_breaker/circuit_breaker_factory_resolver/#database_circuit_breaker_factory_resolver).
