...
The settings are the same as [backoff policies](/docs/utilities/backoff_policies) settings.
...
You can use any of defined [backoff policies](/docs/utilities/backoff_policies).
...
You can use any of defined [rate-limiter policies](/docs/reliability/rate-limiter/configuring_rate_limiter_policies) or [create your own](/docs/reliability/rate-limiter/creating_rate_limiter_policies).
...
3. Provide a string serializer ([`ISerde`](/docs/foundation/serde)). We recommend using `SuperJsonSerdeAdapter` for this purpose.
