...
you can use the [`getOr`](#get_or) method.
...
you can use the [`getOrFail`](#get_or_fail) method.
...
<div style={{display:"flex", flexDirection:"row", gap:"1rem"}}>
    ...
    <li style={{listStyleType:"none"}}>
        ...
        <ol><a href="#after_or">afterOr</a></ol>
        <ol><a href="#after_or_fail">afterOrFail</a></ol>
        <ol><a href="#append">append</a></ol>
        <ol><a href="#average">average</a></ol>
        <ol><a href="#before">before</a></ol>
        <ol><a href="#before_or">beforeOr</a></ol>
        <ol><a href="#before_or_fail">beforeOrFail</a></ol>
        <ol><a href="#change">change</a></ol>
        <ol><a href="#chunk">chunk</a></ol>
        <ol><a href="#chunk_while">chunkWhile</a></ol>
        <ol><a href="#collapse">collapse</a></ol>
        <ol><a href="#count">count</a></ol>
        <ol><a href="#count_by">countBy</a></ol>
        <ol><a href="#cross_join">crossJoin</a></ol>
        ...
        <ol><a href="#first_or">firstOr</a></ol>
        <ol><a href="#first_or_fail">firstOrFail</a></ol>
        <ol><a href="#flat_map">flatMap</a></ol>
        <ol><a href="#for_each">forEach</a></ol>
        <ol><a href="#get">get</a></ol>
        <ol><a href="#get_or">getOr</a></ol>
        <ol><a href="#get_or_fail">getOrFail</a></ol>
        <ol><a href="#group_by">groupBy</a></ol>
    </li>
...
<div style={{ width: "100%" }}>
    <li style={{ listStyleType: "none" }}>
        <ol>
            <a href="#insert_after">insertAfter</a>
        </ol>
        <ol>
            <a href="#insert_before">insertBefore</a>
        </ol>
        <ol>
            <a href="#is_empty">isEmpty</a>
        </ol>
        <ol>
            <a href="#is_not_empty">isNotEmpty</a>
        </ol>
        <ol>
            <a href="#join">join</a>
        </ol>
        ...
        <ol>
            <a href="#last_or">lastOr</a>
        </ol>
        <ol>
            <a href="#last_or_fail">lastOrFail</a>
        </ol>
        <ol>
            <a href="#map">map</a>
        </ol>
        ...
        <ol>
            <a href="#pad_end">padEnd</a>
        </ol>
        <ol>
            <a href="#pad_start">padStart</a>
        </ol>
        <ol>
            <a href="#page">page</a>
        </ol>
        ...
        <ol>
            <a href="#search_first">searchFirst</a>
        </ol>
        <ol>
            <a href="#search_last">searchLast</a>
        </ol>
        <ol>
...
<div style={{width:"100%"}}>
    <li style={{listStyleType:"none"}}> 
        ...
        <ol><a href="#skip_until">skipUntil</a></ol> 
        <ol><a href="#skip_while">skipWhile</a></ol> 
        ...
        <ol><a href="#take_until">takeUntil</a></ol> 
        <ol><a href="#take_while">takeWhile</a></ol> 
        <ol><a href="#tap">tap</a></ol> 
        <ol><a href="#to_array">toArray</a></ol> 
        <ol><a href="#to_iterator">toIterator</a></ol> 
        <ol><a href="#to_map">toMap</a></ol> 
        <ol><a href="#to_record">toRecord</a></ol> 
        <ol><a href="#unique">unique</a></ol> 
        <ol><a href="#values">values</a></ol> 
        <ol><a href="#when">when</a></ol> 
        <ol><a href="#when_empty">whenEmpty</a></ol> 
        <ol><a href="#when_not">whenNot</a></ol> 
        <ol><a href="#when_not_empty">whenNotEmpty</a></ol> 
