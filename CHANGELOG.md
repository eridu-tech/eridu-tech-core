...
- f11bcc4: Made metric tracking synchronous in the `CircuitBreakerFactory` and `RateLimiterFactory` components.
...
- 938a9d1: Declared the optional runtime integrations as peer dependencies and removed the unused `raw-loader` dev dependency.
